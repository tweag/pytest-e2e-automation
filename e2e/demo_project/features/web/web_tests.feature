...
Feature:  OrangeHRM Login and Modus QA blog
  ...
  @hrm_login @hrm_logout @automated @firefox @healthcheck @test1
...
#    When The element 'OrangeHRM > User > success_message' is displayed
    ...
    Then I expect 'OrangeHRM > User > search_result' elements are present with inner text:
      | Tauqir_Sarwar |
      | ESS           |
  ...
  Scenario: Check QA modus blog Search
    ...
    Then The title is 'Modus Create | AI, meet ROI.'
    When The element 'Modus_Site > main_heading' is displayed
    And I click item 'BLOG' for element 'Modus_Site > header_link'
    Then The title is 'Blog | Digital Transformation Insights - Modus Create'
...
#   And I select the option 'quality-assurance' by value for element 'Modus_Site > dropdown'
    ...
    Then The title is 'How to Avoid Flaky Tests? - Modus Create'
    When I scroll to element 'Modus_Site > blog_heading_1'
...
#    And The element 'Modus_Site > sub_popup_close' is displayed
  ...
  Scenario: Check QA modus job Search
    ...
    Then The title is 'Modus Create - Careers | Digital Transformation Consultants'
    When The element 'Modus_Site > Careers > dropdown_area' is displayed
